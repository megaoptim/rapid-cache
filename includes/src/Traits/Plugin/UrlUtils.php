...
{
    /**
     * URL to a Rapid Cache plugin file.
     *
     * @since 1.0.0
     *
    ...
    {
        $url = rtrim(plugin_dir_url(MEGAOPTIM_RAPID_CACHE_PLUGIN_FILE), '/');
        $url .= (string) $file;
     ...
     *
     * @param  null  $blog_id  (Optional) Blog ID. Default null (current blog).
     *
