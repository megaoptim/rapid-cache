...
class Actions extends AbsBase
{
    ...
    protected function ajaxWipeCache($args)
    {
        ...
        $response = sprintf(__('<p>Wiped a total of <code>%2$s</code> cache files.</p>', 'rapid-cache'), esc_html(NAME), esc_html($counter));
    ...
    protected function ajaxClearCache($args)
    {
        ...
        $response = sprintf(__('<p>Cleared a total of <code>%2$s</code> cache files.</p>', 'rapid-cache'), esc_html(NAME), esc_html($counter));
