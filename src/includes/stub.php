...
define(__NAMESPACE__.'\\NAME', 'Rapid Cache');
define(__NAMESPACE__.'\\DOMAIN', 'wprapidcache.com');
define(__NAMESPACE__.'\\GLOBAL_NS', 'rapid_cache');
define(__NAMESPACE__.'\\SLUG_TD', 'rapid-cache');
...
foreach (['Classes', 'Traits\\Shared', 'Traits\\Ac', 'Traits\\Plugin', 'Interfaces\\Shared'] as ${__FILE__}['_sub_namespace']) {
    ...
    define(__NAMESPACE__.'\\'.${__FILE__}['_sub_namespace'].'\\SLUG_TD', 'rapid-cache');
...
class_alias(__NAMESPACE__.'\\Classes\\AdvCacheBackCompat', 'MegaOptim\\RapidCache\\AdvCacheBackCompat');
class_alias(__NAMESPACE__.'\\Classes\\AdvancedCache', 'MegaOptim\\RapidCache\\AdvancedCache');
