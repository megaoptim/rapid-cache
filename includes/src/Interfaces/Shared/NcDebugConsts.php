<?php
namespace MegaOptim\RapidCache\Interfaces\Shared;
...
interface NcDebugConsts
{
    ...
    /**
     * No-cache because the {@link \RAPID_CACHE_ALLOWED} constant says not to.
     *
     * @since 1.0.0
     *
     * @type string A unique string identifier in the set of `NC_DEBUG_` constants.
     */
    const NC_DEBUG_RAPID_CACHE_ALLOWED_CONSTANT = 'nc_debug_rapid_cache_allowed_constant';

    /**
     * No-cache because the `$_SERVER['RAPID_CACHE_ALLOWED']` environment variable says not to.
     *
     * @since 1.0.0
     *
     * @type string A unique string identifier in the set of `NC_DEBUG_` constants.
     */
    const NC_DEBUG_RAPID_CACHE_ALLOWED_SERVER_VAR = 'nc_debug_rapid_cache_allowed_server_var';
    ...
    /**
     * No-cache because the current request includes the `?[MEGAOPTIM_RAPID_CACHE_SHORT_NAME]AC=0` parameter.
     *
     * @since 1.0.0
     *
     * @type string A unique string identifier in the set of `NC_DEBUG_` constants.
