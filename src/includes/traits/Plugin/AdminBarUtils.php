...
trait AdminBarUtils
{
    ...
    public function adminBarStyles()
    {
        ...
        wp_enqueue_style(GLOBAL_NS.'-admin-bar', $this->url('/assets/css/admin-bar.min.css'), $deps, VERSION, 'all');
    }
    /**
    ...
    public function adminBarScripts()
    {
        ...
        wp_enqueue_script(GLOBAL_NS.'-admin-bar', $this->url('/assets/js/admin-bar.min.js'), $deps, VERSION, true);
    }
}
