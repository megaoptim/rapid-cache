...
trait HtaccessUtils
{
    ...
    public function addWpHtaccess()
    {
        ...
        $template_header           = '# BEGIN '.MEGAOPTIM_RAPID_CACHE_NAME.' '.$this->htaccess_marker.' (the '.$this->htaccess_marker.' marker is required for '.MEGAOPTIM_RAPID_CACHE_NAME.'; do not remove)';
        $template_footer           = '# END '.MEGAOPTIM_RAPID_CACHE_NAME.' '.$this->htaccess_marker;
    ...
    public function removeWpHtaccess()
    {
        ...
        $regex                     = '/#\s*BEGIN\s+'.preg_quote(MEGAOPTIM_RAPID_CACHE_NAME, '/').'\s+'.$this->htaccess_marker.'.*?#\s*END\s+'.preg_quote(MEGAOPTIM_RAPID_CACHE_NAME, '/').'\s+'.$this->htaccess_marker.'\s*/uis';
