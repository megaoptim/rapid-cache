...
trait CachePathUtils
{
    ...
    public function filterQueryVars($_vars)
    {
        ...
        $vars                          = $_vars; // Copy.
        $short_name_lc                 = mb_strtolower(MEGAOPTIM_RAPID_CACHE_SHORT_NAME);
        $ignore_get_request_vars_regex = defined('RAPID_CACHE_IGNORE_GET_REQUEST_VARS') ? RAPID_CACHE_IGNORE_GET_REQUEST_VARS : '';
