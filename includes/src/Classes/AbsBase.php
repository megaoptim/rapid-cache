...
abstract class AbsBase implements Interfaces\Shared\NcDebugConsts, Interfaces\Shared\CachePathConsts
{
    ...
    {
        $this->plugin = &$GLOBALS[MEGAOPTIM_RAPID_CACHE_GLOBAL_NS];
    ...
    public function __get($property)
    {
        ...
        throw new \Exception(sprintf(__('Undefined overload property: `%1$s`.', 'rapid-cache'), $property));
    }
    ...
    public function __set($property, $value)
    {
        ...
        throw new \Exception(sprintf(__('Refused to set overload property: `%1$s`.', 'rapid-cache'), $property));
    }
    ...
    public function __unset($property)
    {
        ...
        throw new \Exception(sprintf(__('Refused to unset overload property: `%1$s`.', 'rapid-cache'), $property));
    }
