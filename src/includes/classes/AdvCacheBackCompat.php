...
class AdvCacheBackCompat
{
    ...
    /**
     * Back compat. with `RAPID_CACHE_ALLOW_BROWSER_CACHE` constants.
     *
     * @since 160706 Renaming RAPID_CACHE_ALLOW_BROWSER_CACHE to RAPID_CACHE_ALLOW_CLIENT_SIDE_CACHE
     */
    public static function browserCacheConstant()
    {
        $_global_ns = mb_strtoupper(GLOBAL_NS);

        if (defined('RAPID_CACHE_ALLOW_BROWSER_CACHE')) {
            define($_global_ns.'_ALLOW_CLIENT_SIDE_CACHE', RAPID_CACHE_ALLOW_BROWSER_CACHE);
        }
    }
}
