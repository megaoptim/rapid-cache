...
trait MenuPageUtils
{
    ...
    public function enqueueAdminStyles()
    {
        ...
        wp_enqueue_style(GLOBAL_NS, $this->url('/assets/css/menu-pages.min.css'), $deps, VERSION, 'all');
    }
    ...
    public function enqueueAdminScripts()
    {
        ...
        wp_enqueue_script(GLOBAL_NS, $this->url('/assets/js/menu-pages.min.js'), $deps, VERSION, true);
        wp_localize_script(
            GLOBAL_NS,
    ...
    public function addNetworkMenuPages()
    {
        ...
        add_submenu_page(GLOBAL_NS, __('Plugin Options', 'rapid-cache'), __('Plugin Options', 'rapid-cache'), $this->network_cap, GLOBAL_NS, [$this, 'menuPageOptions']);
    ...
    public function addMenuPages()
    {
        ...
        add_submenu_page(GLOBAL_NS, __('Plugin Options', 'rapid-cache'), __('Plugin Options', 'rapid-cache'), $this->cap, GLOBAL_NS, [$this, 'menuPageOptions']);
    ...
    public function addSettingsLink($links)
    {
        ...
        $links[] = '<a href="'.esc_attr(add_query_arg(urlencode_deep(['page' => GLOBAL_NS]), self_admin_url('/admin.php'))).'">'.__('Settings', 'rapid-cache').'</a>';
        if (!IS_PRO) {
            $links[] = '<br/><a href="'.esc_attr(add_query_arg(urlencode_deep(['page' => GLOBAL_NS, GLOBAL_NS.'_pro_preview' => '1']), self_admin_url('/admin.php'))).'">'.__('Preview Pro Features', 'rapid-cache').'</a>';
            $links[] = '<a href="'.esc_attr('http://rapidcache.com/prices/').'" target="_blank">'.__('Upgrade', 'rapid-cache').'</a>';
        }
        return $links;
    }
